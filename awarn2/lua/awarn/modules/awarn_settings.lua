...
AWarn.RegisterPunishment( {
	NumberOfWarnings 	=	3,
	PunishmentType 		=	"kick",
	PunishmentMessage	=	"AWarn: Vous Avez ete Kick Raison Trops De Warn",
	PunishmentLength 	=	nil,
} )
...
AWarn.RegisterPunishment( {
	NumberOfWarnings 	=	5,
	PunishmentType 		=	"ban",
	PunishmentMessage	=	"AWarn: Vous avez Ete Bannie Pendant 1h De Notre Serveur Raison: Trops de Warn",
	PunishmentLength 	=	60,
} )
...
AWarn.RegisterPunishment( {
	NumberOfWarnings 	=	30,
	PunishmentType 		=	"ban",
	PunishmentMessage	=	"AWarn: Vous avez ete bannie Permaban Raison Trops de Warn ( 30 ) Warn.",
	PunishmentLength 	=	0,
} )
