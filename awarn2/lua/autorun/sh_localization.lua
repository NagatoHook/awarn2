...
AWarn.localizations["PL"] = {
    ...
    cl26    =       "Pozwól AWarn aby KICKOWAĆ graczy (zdefiniowane w pliku kar)", --Found in cl_init.lua
    cl27    =       "Pozwól AWarn aby BANOWAĆ graczy (zdefiniowane w pliku kar)", --Found in cl_init.lua
